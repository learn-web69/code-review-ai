...
router.post("/", async (req, res) => {
    try {
        const { repo_id, file, line, code, question, walkthrough, } = req.body;
        ...
        console.log(`  - Walkthrough context: ${walkthrough ? walkthrough.length + " steps" : "not provided"}`);
        ...
        console.log(`[API] POST /tools/review - Successfully answered question for ${repo_id}`);
        return res.json({
            status: "success",
